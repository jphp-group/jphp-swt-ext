...
- **класс** `UIControl` (`swt\UIControl`) **унаследован от** [`UIWidget`](https://github.com/jphp-compiler/jphp/blob/master/api-docs/classes/swt/UIWidget.ru.md)
- **исходники** `swt/UIControl.php`

**Классы наследники**

> [UIButton](https://github.com/jphp-compiler/jphp/blob/master/api-docs/classes/swt/UIButton.ru.md), [UIComposite](https://github.com/jphp-compiler/jphp/blob/master/api-docs/classes/swt/UIComposite.ru.md)
...
- `->`[`parent`](#prop-parent) : [`UIComposite`](https://github.com/jphp-compiler/jphp/blob/master/api-docs/classes/swt/UIComposite.ru.md)
- *См. также в родительском классе* [UIWidget](https://github.com/jphp-compiler/jphp/blob/master/api-docs/classes/swt/UIWidget.ru.md).
